...
def get_rays(datapath,mode='train'):
    ...
    for i in range(N):
        ...
        img=imageio.imread(datapath+'/imgs/'+name.replace('txt','png'))/255. # Chnage 'jpg' or 'png' accordingly
    ...
    # Rays are parametrized by two components, origin of rays, and the direction. Basically a vector.
